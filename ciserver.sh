...
# installing git and cloning the repository from github.com
	sudo apt-get install git -y
	 cd ~
	sudo git clone -b vp-memcached-rabbitmq-elasticsearch https://github.com/wkhanvisualpathit/VProfile.git
...
# inserting data base credentials into application.properties
	...
	sed -i 's/newuser/root/g' src/main/resources/application.properties
        sed -i 's/localhost:3306/db.com:3306/' src/main/resources/application.properties
	sed -i 's/address=127.0.0.1/address='rmq.com'/' src/main/resources/application.properties
        
        sed -i 's/active.host=127.0.0.1/active.host='memcache.com'/' src/main/resources/application.properties
...
# installing git and cloning the repository from github.com
	...
	cd ~
        ...
        echo "    "
	git clone -b vp-memcached-rabbitmq-elasticsearch https://github.com/wkhanvisualpathit/VProfile.git
